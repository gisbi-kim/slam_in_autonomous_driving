...
struct ESKFOptions {
    ...
    double gyro_var_ = 1e-2;  // 1e-5, Gyroscope measurement standard deviation
    double acce_var_ =
        1e-2;  // 1e-2, Accelerometer measurement standard deviation
    double bias_gyro_var_ =
        1e-3;  // 1e-6;, Gyroscope bias random walk standard deviation
    double bias_acce_var_ =
        1e-3;  // 1e-4;, Accelerometer bias random walk standard deviation
    ...
    double gnss_pos_noise_ = 1.0;                   // 0.1,. GNSS position noise
    double gnss_height_noise_ = 1.0;                // 0.1, GNSS height noise
    double gnss_ang_noise_ = 5.0 * math::kDEG2RAD;  // 1.0, GNSS rotation noise
